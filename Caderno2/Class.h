...
public:
    ...
    Funcionario(int _num_func, string _setor,string _nome, int _dia ,int _mes, int _ano, string _morada)
        :Pessoa(_nome,_dia,_mes,_ano,_morada){
            num_func = _num_func;
            setor =  _setor;
        }
    ...
    friend ostream& operator << (ostream& os , Funcionario& obj){

        os << "Numero de funcionario: " << obj.num_func << endl;
        os << "Setor: " << obj.setor << endl;
        os << (Pessoa &) obj;
        return os;
    }

    
    friend istream& operator >> (istream& is , Funcionario& obj){

        cout << "Indique um numero de funcionario: ";
        is >> obj.num_func;
        cout << "Infique um setor";
        getline(is,obj.setor);
        is >> (Pessoa &) obj;
